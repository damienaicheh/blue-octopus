resource "azapi_resource" "java_dev_box_definition" {
  ...
  parent_id = local.reformat_dev_center_id
  tags      = local.tags_azapi
  body = {
    properties = {
      hibernateSupport = "Enabled"
      imageReference = {
        id = "${local.reformat_dev_center_id}/galleries/default/images/microsoftvisualstudio_visualstudioplustools_vs-2022-ent-general-win11-m365-gen2"
      }
...
#   image_reference_id = "${local.reformat_dev_center_id}/galleries/default/images/microsoftvisualstudio_visualstudioplustools_vs-2022-ent-general-win11-m365-gen2"
