...
resource "azurerm_private_dns_zone_virtual_network_link" "privatelink_container_registry" {
  name                  = format("pdzvnl-%s", azurerm_private_dns_zone.privatelink_azurecr_io.name)
